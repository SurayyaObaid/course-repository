                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                       <li class="dropdown">
                        ...
                        <div class="dropdown">
                          <button style="color: black;font-size:initial" class="btn btn-light mt-3 dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Courses
                          </button>
                          <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="adminhome.php">Courses</a>
                            <a class="dropdown-item" href="admindynamicview.php">Current Courses</a></div>
                          <!--<li class="nav-item"><select class="border-0" style="margin-top: 15px; width: 110px; font-size:initial">
                              <option><a href="adminhome.php">Courses</a></option>
                              <option><a href="admindynamicview.php">Current Courses</a></option>
                          </select></li>-->
