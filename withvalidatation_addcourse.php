...
if(isset($_POST['add_course'])){
      ...
      $domain1 = $_POST['domain1'];
             ...
             // $nceacfilename = $code + 'nceac_doc';
              ...
              $insert = "INSERT INTO `course`(`course_Code`, `course_Title`, `course_Outline`, `course_LOs`, `creadit_Hours`, `recommended_Books`, `weekly_Breakup_theory`, `weekly_Breakup_lab`, `pre-requisites`, `NCEAC Doc`, `added_By`) VALUES ('$code', '$title', '$obj', '$clo', `$credit`, '$books', '$twb_new', '$lwb_new', '$prereqs', '$nceac_new' ,'$added_By')";
...
<script>
  function validate(){
    ...
    var cprereqs = document.getElementById("cprereqs").value;
...
<body style="margin-top:20px;">
  ...
  <form method="post" class="w-50" onsubmit="return validate()" enctype="multipart/form-data" action="addcourse.php">
    
    <div class="input-group">
      <label>Course Code</label>
      <input name="code" id="ccode" type="text" pattern="(?(\w{3})\)?+[ ]+(\d{4})" maxlength="8" required="required">
      <span id="codemessage"></span>
    </div>
    <div class="input-group">
      <label>Course Title</label>
      <input name="title" id="ctitle" type="text" required="required">
    </div>
    <!--<div class="input-group">
    ...
    <div class="input-group">
      ...
      <select class="bg-light border border-dark col-lg-11 rounded" id="ccredit" name="credit" id="credit">
    ...
    <div class="input-group">
      ...
      <input type="text" class ="h-25" name="books" id="cbook" required="required">
    </div>
    <div class="input-group">
    ...
    <div class="input-group">
      ...
      <input name="prereqs" type="text" id="cprereqs" required="required">
    </div>
    ...
    <table border="2" class="table table-striped">
            ...
            <td style="width: 85%;"><input required="required" style="width: 85%;" type="text" name="outline1" placeholder="Objective" /></td></tr>

            <tr >

            <td style="width: 15%;">2</td>
            <td style="width: 85%;"><input required="required" style="width: 85%;" type="text" name="outline2" placeholder="Objective" /></td></tr>

            <tr>

            <td style="width: 15%;">3</td>
            <td style="width: 85%;"><input required="required" style="width: 85%;" type="text" name="outline3" placeholder="Objective" /></td></tr>

            <tr>
            <td style="width: 15%;">4</td>
            <td style="width: 85%;"><input required="required" style="width: 85%;" type="text" name="outline4" placeholder="Objective" /></td></tr>

            <tr>

            <td style="width: 15%;">5</td>
            <td style="width: 85%;"><input required="required" style="width: 85%;" type="text" name="outline5" placeholder="Objective" /></td></tr>
      ...
      <tr>
        ...
        <th><center>BT Level</center></th>
             ...
             <tr >
              ...
              <td style="width: 45%;"><input required="required" style="width: 90%;" type="text" name="clo1" placeholder="CLO here" >
              </td>
              <td style="width: 20%;"><input required="required" style="width: 85%;" type="text" name="domain1" maxlength="1" pattern="[a-zA-Z]{1}" placeholder="Domain" /></td>
            ...
            <tr >
              ...
              <td style="width: 45%;"><input required="required" style="width: 90%;" type="text" name="clo2" placeholder="CLO here" >
              </td>
              <td style="width: 20%;"><input required="required" style="width: 85%;" type="text" name="domain2" pattern="[a-zA-Z]{1}" placeholder="Domain" /></td>
            ...
            <tr >
              ...
              <td style="width: 45%;"><input required="required" style="width: 90%;" type="text" name="clo3" placeholder="CLO here" >
              </td>
              <td style="width: 20%;"><input required="required" style="width: 85%;" type="text" name="domain3" pattern="[a-zA-Z]{1}" placeholder="Domain" /></td>
              <td><select class="bg-light border border-dark col-lg-11 rounded" required="required" name="btlevel3">Domain 
                <option value="1">1</option>
                <option value="2">2</option>
                <option value="3">3</option>
                <option value="4">4</option>
            ...
            <tr >
              ...
              <td style="width: 20%;"><input style="width: 85%;" type="text" name="domain4" pattern="[a-zA-Z]{1}" placeholder="Domain" /></td>
